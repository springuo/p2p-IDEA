...
public class UserController {
    ...
    public Object msgRegister(HttpServletRequest request,
        ...
        try {
            ...
            retMap.put(Constants.CODE, Constants.SUCCESS);

        } catch (Exception e) {
            e.printStackTrace();
            logger.info("理财用户注册失败,失败原因：" + e.getMessage());
            retMap.put(Constants.CODE, Constants.ERROR);
            retMap.put(Constants.MESSAGE, e.getMessage());
        }
    ...
    public Object verifyRealName(HttpServletRequest request,
                                 ...
                                 @RequestParam(value = "replayIdCard", required = true) String replayIdCard) throws Exception {
        Map<String, Object> retMap = new HashMap<String, Object>();
...
//        request.getSession().removeAttribute(Constants.SESSION_USER);
    ...
    public @ResponseBody
    Object loadStat(HttpServletRequest request) {
